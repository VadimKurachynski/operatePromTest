...
<div className={s.body}>
            ...
            <div className={s.nameTheme}>Тема 01 - Председатель (заместитель председателя) комиссии для проверки знаний по вопросам промышленной
            ...
            <div className={s.question}>
                <div className={s.questionText}> Какими полномочиями наделен работник службы промышленной безопасности
